			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-4">
					...
					<ul class="font-11 list-relative list-li-pl-30 list-block list-li-mb-15">
						<li><i class="abs-tl ion-ios-location"></i>HaNoi<br/>79 cau giay </li>
						<li><i class="abs-tl ion-android-mail"></i>macvantoanhd@gmail.com</li>
						<li><i class="abs-tl ion-android-call"></i>0032966654</li>
					</ul>
