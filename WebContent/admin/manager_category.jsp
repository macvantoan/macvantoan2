    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <%
            if (session.getAttribute("userAdmin") == null) {
                response.sendRedirect("/vuihihi/admin/login.jsp");
            }
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <form method="get" action="/vuihihi/ManagerCategoryServlet">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn  btn-sm btn-danger" href="/vuihihi/ManagerCategoryServlet?command=delete&category_id=<%=category.getCategoryID()%>"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <%}%>
                                        <tfoot>
