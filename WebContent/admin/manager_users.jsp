                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <form method="get" action="/vuihihi/ManagerUsersServlet">
                                        <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered ">
                                        ...
                                        <tr>
                                            ...
                                            <td>			                    		
                                                ...
                                                <a class="btn  btn-sm btn-danger" href="/vuihihi/ManagerUsersServlet?command=delete&userid=<%=user.getUserID()%>"><i class="fa fa-trash"></i></a>
