                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <form method="get" action="/vuihihi/ManagerContactServlet">
                                        <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered ">
                                        ...
                                        <tr>
                                            ...
                                            <td>			                    		
                                                ...
                                                <a class="btn  btn-sm btn-danger" href="/vuihihi/ManagerContactServlet?command=delete&contactid=<%=contact.getContactID()%>"><i class="fa fa-trash"></i></a>
